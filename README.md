...
El primer acercamiento al robot _Phantom\_X_ se realizó con el software _Dynamixel Wizard_. Se modificó cada articulación y se fijo la opción de torque para que se mantuviera fija la articulación. Esta primera interacción fue satisfactoria y nos dió pie para arrancar la comunicación de ROS con Phyton.
